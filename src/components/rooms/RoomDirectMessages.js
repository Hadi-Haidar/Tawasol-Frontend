...
const RoomDirectMessages = ({ room, currentUser }) => {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
      {/* Tab Navigation - Responsive, Header Removed */}
      <div className="p-3 sm:p-4 border-b border-gray-200 dark:border-gray-700">
        <div className="flex gap-1 sm:gap-1 bg-gray-100 dark:bg-gray-700 rounded-lg p-1">
          ...
          >
            ...
            {unreadCount > 0 && activeView === 'conversations' && (
              <span className="px-1.5 py-0.5 rounded-full text-xs font-medium bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-200 flex-shrink-0">
                {unreadCount}
              </span>
            )}
          </button>
          ...
          <button
            ...
            className="p-2 text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 hover:bg-gray-200 dark:hover:bg-gray-600 rounded-md transition-colors touch-manipulation flex-shrink-0 min-w-[44px] sm:min-w-0"
            title="Refresh"
            aria-label="Refresh"
          >
          ...
          <>
            {conversations.length === 0 ? (
              <div className="text-center py-6 sm:py-8">
                <ChatBubbleLeftRightIcon className="w-10 h-10 sm:w-12 sm:h-12 text-gray-400 mx-auto mb-3 sm:mb-4" />
                ...
                <button
                  onClick={() => setActiveView('members')}
                  className="inline-flex items-center gap-2 px-4 py-2.5 sm:py-2 bg-blue-500 hover:bg-blue-600 active:bg-blue-700 text-white rounded-lg text-sm transition-colors touch-manipulation min-h-[44px] sm:min-h-0"
                >
              ...
              <div className="space-y-3">
                {conversations.map((conversation) => (
                  <div
                    ...
                    className="p-3 sm:p-4 hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer transition-colors rounded-lg border border-gray-100 dark:border-gray-600 hover:border-blue-200 dark:hover:border-blue-600 touch-manipulation"
                  >
                    <div className="flex items-center gap-2 sm:gap-3">
                          ...
                          <div className="flex items-center gap-1.5 sm:gap-2 flex-1 min-w-0">
                            ...
                            <div className="flex items-center gap-1 flex-shrink-0">
                              ...
                              {conversation.other_user?.id === roomData?.owner?.id ? (
                                <span className="inline-flex items-center px-1.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800 dark:bg-blue-900 dark:text-blue-200 whitespace-nowrap">
                      ...
                      {/* Online Status Indicator - Design Only */}
