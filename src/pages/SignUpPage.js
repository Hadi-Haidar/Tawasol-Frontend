...
import { Eye, EyeOff, Mail, Lock, User, Moon, Sun, ArrowLeft } from 'lucide-react';
...
const SignUpPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Show different message after 3 seconds
    ...
    try {
      ...
      // Check if this is a redirect to verification case
      if (response?.status === 'redirect_to_verification') {
      ...
      // If it's a timeout error, also set a success-like message
      if (err.message.includes('timeout')) {
        setSuccess('If you received a verification code, you can verify your email now.');
      }
    } finally {
      setLoading(false);
    }
  ...
  const handleGoogleSignUp = () => {
    try {
      googleLogin(); // Same flow as login - will create account if needed
    } catch (error) {
        ...
        <div className="max-w-md w-full space-y-8">
          ...
          <div className="bg-white dark:bg-gray-800 py-8 px-6 shadow-lg rounded-xl border border-gray-200 dark:border-gray-700">
              ...
              <div className="mb-4 p-3 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg">
                ...
                <div className="mt-3">
                  <button
                    ...
                    className="text-sm text-green-700 dark:text-green-300 underline hover:text-green-800 dark:hover:text-green-200"
                  >
                    Verify email now →
                  </button>
                </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              >
                {loading ? loadingMessage || 'Creating account...' : 'Create account'}
              </button>
            </form>
